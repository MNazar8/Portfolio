  ...
  return (
    <section id='contact' className=' bg-black h-auto text-white flex flex-row pl-24 pt-7 pb-7 pr-7 items-center'>
      ...
      <div className=' w-2/3'>
        ...
        <div className=' py-6'>
        <a href="./src/assets/pdf/CV-EN.pdf" target='_blank' download="CV-EN.pdf" className=' bg-white px-4 py-2 text-black font-Montserrat font-semibold'>Download my CV</a>
        </div>
        <div className=' flex'>
